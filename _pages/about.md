...
My research focuses on designing conversational systems that facilitate effective communication between general users and domain experts, especially in contexts where credibility and scientific information are involved. I extend and build on social science theories and empirically evaluate the effects of these systems in real or simulated use contexts.
