---
layout: page
title: Voice Persona Search Engine 
description: Designing prototypes for voice search in voice databases
img: assets/img/prototype.png
importance: 9
related_publications: byeon2022voice, byeon2021voice, byeon2021voice
keywords:
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/prototype.png" title="Prototype Design" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/search.png" title="Search Engine Interface" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
